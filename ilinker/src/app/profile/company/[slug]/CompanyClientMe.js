        ...
        <>
            <div className="min-h-screen bg-gray-100">
                ...
                <div className="relative h-80 bg-gray-300">
                    <img
                        src={companyEdited?.cover_photo ? `http://localhost:8000/storage/${companyEdited.cover_photo}` : coverImage}
                        alt="Cover"
                        ...
                        <div className="bg-white rounded-lg shadow-lg p-6">
                                ...
                                <div className="sm:flex sm:space-x-5">
                                    <div className="relative flex-shrink-0">
                                        <img
                                            ...
                                            src={companyEdited?.logo ? `http://localhost:8000/storage/${companyEdited.logo}` : logoImage}
                            ...
                            <div className="mt-6 border-t border-gray-200 pt-6">
                                ...
                                {isEditing === 'about' ? (
                                    ...
                                    <div dangerouslySetInnerHTML={{__html: companyEdited.description}}/>
                                )}
                            </div>
                        </div>
                            ...
                            <TabsContent value="acerca" className="mt-6">
                                <Card className="p-6">
                                    <div className="flex justify-between items-center mb-4">
                                        ...
                                        <h2 className="text-xl font-semibold mb-4">Acerca de {companyEdited.name}</h2>
                                        <button
                                    ...
                                    {isEditing === "description" ? (
                                        ...
                                        <div className="mb-6"
                                             dangerouslySetInnerHTML={{__html: companyEdited.description}}/>
                                    </>)}
                                        ...
                                        <div className="">
                                            ...
                                            {isEditing === "description" ? (
                                                ...
                                                <ul className="space-y-2 text-gray-600">
                                                    <li><strong>Sitio web:</strong> {companyEdited.website}</li>
                                                    <li>
                                                        <strong>Industria:</strong>{" "}
                                                        {companyEdited.sectors && companyEdited.sectors.length > 0 ? (
                                                    ...
                                                    <li><strong>Numero de empleados:</strong> {companyEdited.num_people}
                                                    </li>
                                                    <li><strong>Fundada:</strong> {companyEdited.founded}</li>
                                                </ul>
                                            )}
                                        </div>
                                        <div>
                                            ...
                                            {isEditing === "description" ? (
                                                <>
                                                    <Select
                                                        ...
                                                        onChange={(selectedOption) => {
                                                            console.log(selectedOption);
                                                            setCompanyEdited({...companyEdited, skills: selectedOption})
                                                        }}
                                                    />
                                                </>
                                            ) : (<>
                                                <div className="flex flex-wrap gap-2 text-gray-600">
                                                    {companyEdited.skills && companyEdited.skills.length > 0 ? (
                                        ...
                                        <div className="flex justify-between items-start">
                                            <div>
                                                ...
                                                <div className="mt-2 space-y-1">
                                                    ...
                                                    <p className="text-gray-600">{job.location_type || "Sin información"}</p>
                                                    <div dangerouslySetInnerHTML={{__html: job.description}}/>
                                                    <p className="text-sm text-gray-500">Publicado
                                                        hace {formatDistanceToNow(new Date(job.created_at), {addSuffix: true})}</p>
                                                </div>
                                            </div>
                                            <Button className="text-white" onClick={()=> handleOpenModalEditOffer(job)}>
                                                Editar
                                            </Button>
                                        </div>
                                    </Card>
