        ...
        <div className="space-y-6">
            ...
            <div className="space-y-4">
                ...
                <p className="text-muted-foreground">
                    We are seeking a talented Senior Software Engineer to join our dynamic team. In this role, you will
            ...
            <div className="space-y-4">
                ...
                <p className="text-muted-foreground">
                    Tech Company Inc. is a leading technology company focused on building innovative solutions that help
                    businesses grow. Our mission is to empower organizations with cutting-edge tools and technologies
                                    ...
                                    <div className="flex justify-between items-start">
                                        <div className="space-y-4">
                                            ...
                                            <div className="flex flex-wrap gap-2">
                                                ...
                                                <Badge variant="secondary">$130K - $180K</Badge>
                                            </div>
                                        </div>
